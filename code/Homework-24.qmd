...
2.  Examine the response and predictor variables and use the flow chart from class to decide the appropriate statistical analysis (choose from: chi-square, 2-sample t-test or linear regression). Explain your answer here: Doing a regression because predictor variable is continuous and we are testing for a relationship between the predictor and response variables.
...
The P-value is 2.2X10\^-16 which indicates that height is a statistically significant predictor of the height of crabs, whether or not the outliers are included.
